<script setup>
    ...
    const form = useForm({
        ...
        featured: Boolean(props.item.featured) ?? false,
        showOnSlider: Boolean(props.item.show_on_slider) ?? false,
    });
    ...
    const deleteImage = (imageId) => {
        ...
        Inertia.post(route('admin.images.destroy', {
            id:imageId
        }))
    };
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-2 gap-6">
                        <div v-if="edit" class="col-span-2">
                            ...
                            <ImageUpload v-if="item.images.length < maxUploadImageCount" :max-files="maxUploadImageCount - item.images.length" model-type="product" :model-id="item.id"/>
                        </div>
                        <InputGroup 
                            label="Name" 
                            v-model="form.name" 
                        ...
                        <div class="col-span-2 flex items-center space-x-4">
                            ...
                            <CheckboxGroup 
                                ...
                                :error-message="form.errors.showOnSlider" 
                            />
                        </div>
                    </div>
                    <div class="mt-4">
